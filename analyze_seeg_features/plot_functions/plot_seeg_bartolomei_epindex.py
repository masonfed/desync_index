...
def plot_seeg_bartolomei_epindex(energy_folder: str,
                                 epindex_folder: str,
                                 patient: str,
                                 work_signal: list,
                                 work_channels: list,
    ...
    if plot_montage is None:
        ...
        plot_channels, plot_channel_indexes =\
            get_plot_labels(work_channels, [np.max(epindex_values) for epindex_values in epindex_values_per_channel], max_plot_num)
        ...
        plot_channel_indexes = np.asarray([list(work_channels).index(channel) for channel in plot_channels]).astype(int)
    ...
    plot_cumulative_sums(plot_channels,
                         ...
                         energy_ratios_per_channel[plot_channel_indexes, window_time_start:window_time_end],
